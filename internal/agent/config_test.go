...
func TestLoadConfig_RejectsMissingFields(t *testing.T) {
	cases := []struct {
		...
		{"empty", ""},
		{"missing server_address", "executors: 2\ncertificate: /c\nkey: /k\nca_certificate: /ca\n"},
		{"executors zero", "server_address: a:1\nexecutors: 0\ncertificate: /c\nkey: /k\nca_certificate: /ca\n"},
		{"missing certificate", "server_address: a:1\nexecutors: 1\nkey: /k\nca_certificate: /ca\n"},
		{"missing key", "server_address: a:1\nexecutors: 1\ncertificate: /c\nca_certificate: /ca\n"},
		{"missing ca_certificate", "server_address: a:1\nexecutors: 1\ncertificate: /c\nkey: /k\n"},
	}
